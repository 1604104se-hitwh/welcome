			...
			<li class="nav-item">
				...
				<div id="collapseInfo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						...
						<a class="collapse-item" href="<?php echo e(url('/stu/quiryClass')); ?>">你的班级</a>
						<a class="collapse-item" href="<?php echo e(url('/stu/quiryDorm')); ?>">你的宿舍</a>
						<a class="collapse-item" href="<?php echo e(url('/stu/quiryContryFolk')); ?>">你的老乡</a>
					</div>
				</div>
			</li>
							...
							<div class="card-body">
								<table class="table table-bordered">
									...
									<tbody>
										...
										<tr role="row">
											<td><?php echo e($domStu->name); ?></td>
											<td><?php echo e($domStu->stuID); ?></td>
											<td><?php echo e($domStu->bedID); ?></td>
											<td><?php echo e($domStu->comeFrom); ?></td>
										</tr>
							...
							<div class="card-body">
								<div class="col-sm-12">
									<table class="table table-bordered">
										...
										<tbody>
											<?php if(count($localStus)==0): ?>
											<td colspan="4">还没有信息</td>
											<?php else: ?> <?php $__currentLoopData = $localStus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $localStu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											<tr role="row">
												<td>$localStu->name</td>
									...
									<a target="_blank" rel="nofollow" href="<?php echo e(url($toLocalStuURL)); ?>">查看全部老乡 &rarr;</a>
								</div>
							</div>
						</div>

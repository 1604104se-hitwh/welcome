...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
			...
			<li class="nav-item">
				...
				<div id="collapseInfo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						...
						<a class="collapse-item" href="<?php echo e(url('/admin/manageSchoolInfo')); ?>">学校信息</a>
						<a class="collapse-item" href="<?php echo e(url('/admin/manageNewsInfo')); ?>">新生信息</a>
						<a class="collapse-item" href="<?php echo e(url('/admin/manageAdminInfo')); ?>">管理员信息</a>
					</div>
				</div>
			</li>
			...
			<!-- Nav Item - self info -->
			<li class="nav-item">
				<a class="nav-link" href="<?php echo e(url('/admin/personalInfo')); ?>">
			...
			<!-- Nav Item - Arrived -->
			<li class="nav-item">
				<a class="nav-link" href="<?php echo e(url('/admin/nav')); ?>">
			...
			<!-- Nav Item - Notice -->
			<li class="nav-item">
				<a class="nav-link" href="<?php echo e(url('/admin/posts')); ?>">
			...
			<li class="nav-item">
				...
				<div id="collapseWel" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						...
						<a class="collapse-item" href="<?php echo e(url('/admin/reportInfo')); ?>">报到信息</a>
						<a class="collapse-item" href="<?php echo e(url('/admin/reportCheck')); ?>">迎新核验</a>
					</div>
				</div>
			</li>
								...
								<div class="card-body">
									<div class="row no-gutters align-items-center">
										<div class="col mr-2">
											...
											<div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e($newStuNumber); ?></div>
										</div>
										<div class="col-auto">
								...
								<div class="card-body">
									<div class="row no-gutters align-items-center">
										<div class="col mr-2">
											...
											<div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e($oldStuNumber); ?></div>
										</div>
										<div class="col-auto">
								...
								<div class="card-body">
									<div class="row no-gutters align-items-center">
										<div class="col mr-2">
											...
											<div class="row no-gutters align-items-center">
												<div class="col-auto">
													<div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?php echo e($hasReportNumber); ?>
					...
					<div class="card-columns">
						...
						<div class="card mb-4">
							...
							<div class="card-body">
								...
								<a target="_blank" rel="nofollow" href="<?php echo e(url($toSetSchoolInfoURL)); ?>">去设置 &rarr;</a>
							</div>
						</div>
						...
						<div class="card mb-4">
							...
							<div class="card-body">
								<table class="table table-bordered">
									...
									<tbody>
										<?php if(count($schoolStatistics)==0): ?> 
										<tr role="row">
											<td colspan="4">还没有信息</td>
										</tr>
										<?php else: ?> <?php $__currentLoopData = $schoolStatistics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $schoolStatistic): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<tr role="row">
											<td><?php echo e($schoolStatistic->deptName); ?></td>
											<td><?php echo e($schoolStatistic->stuNumber); ?></td>
											<td><?php echo e($schoolStatistic->hasReportNumber); ?></td>
											<td><?php echo e($schoolStatistic->genderRate); ?></td>
										</tr>
							...
							<div class="card-body">
								<table class="table table-bordered">
									...
									<tbody>
										<tr role="row">
											<th>新生信息</th>
											<td><?php echo e($systemStatus['newsStatus']); ?></td>
										</tr>
										<tr role="row">
											<th>院系信息</th>
											<td><?php echo e($systemStatus['deptStatus']); ?></td>
										</tr>
										<tr role="row">
											<th>报到进程</th>
											<td><?php echo e($systemStatus['reportStatus']); ?></td>
										</tr>
									</tbody>
								</table>
							</div>

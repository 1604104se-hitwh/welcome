                            ...
                            @foreach($enrollInfos as $enrollInfo)
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div style="width: 100%;height: 380px;" id="container<?php echo $id; ?>"></div>
                                    </div>
                                </div>
                                <?php $id++; ?>
                            @endforeach
...
<script type="text/javascript">
    <?php
        for ($i = 0; $i < $id; $i++) {
            echo "var map = new AMap.Map('container$i', {
        resizeEnable: true,
        center: [122.083199, 37.534235],
        zoom: 15
    });";
            echo "var marker = new AMap.Marker({
        position: ".json_encode($enrl_location[$i]['PX']).",

        title: '".$enrl_location[$i]['title']."',
    });
    map.add(marker);";
        }
        ?>
